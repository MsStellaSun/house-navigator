                ...
                <div className="flex-1 p-6 md:p-10 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 overflow-y-auto shadow-inner">
                  ...
                  <div className="space-y-10">
                    ...
                    <div className="pt-6 pb-12 md:pb-0 space-y-3">
                      <button className="w-full bg-slate-900 text-white py-4 rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-black transition-all shadow-lg shadow-slate-200">
                        <span>获取详细楼盘简报</span>
